...
public class TemplateNumRunsAndNumInstances {
    ...
    static Semaphore wakeUp, callClient, clientArived, clientEntered, swag, paid;
    
    public static void init(int numBarbers) {
        wakeUp = new Semaphore(0);
        callClient = new Semaphore(0);
        clientArived = new Semaphore(0);
        clientEntered = new Semaphore(0);
        swag = new Semaphore (0);
        paid = new Semaphore(0);
    }
    ...
    static class Consumer extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            synchronized(state){
            	...
            	if(Barber.sleeping && state.arrivedCustomers == 5){
            		wakeUp.release();
            	}
            }
